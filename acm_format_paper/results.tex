...
\begin{table*}[!thb]
    \begin{center}
        ...
        ArgoUML      &  0.731  & 0.127 & 0.075 &  5.7$\times$   &  9.7$\times$   & 0.595  &  0.083  & 7.1$\times$     \\
        Columba      &  0.814  & 0.078 & 0.155 &  10.4$\times$  &  5.2$\times$   & 0.804  &  0.013  & 61.8$\times$  \\
        EMF          &  0.601  & 0.145 & 0.038 &  4.1$\times$   &  15.8$\times$  & 0.381  &  0.007  & 54.4$\times$  \\
        Hibernate    &  0.470  & 0.114 & 0.035 &  4.1$\times$   &  13.4$\times$  & 0.476  &  0.042  & 11.3$\times$  \\
        JEdit        &  0.744  &  0.15 & 0.214 &  4.9$\times$   &  3.4$\times$   & 0.091  &  0.003  & 30.3$\times$  \\
        JFreeChart   &  0.509  & 0.324 & 0.037 &  1.5$\times$   &  13.7$\times$  & 0.321  &  0.007  & 45.8$\times$    \\
        Jmeter       &  0.492  & 0.053 &  0.08 &  9.2$\times$   &  6.1$\times$   & 0.237  &  0.005  & 47.4$\times$  \\
