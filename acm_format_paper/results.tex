...
% Lastly, for each project we obtained the comment patterns baseline and the random classifier baseline. Then, we store all results in a database to perform our analysis. 
...
\everton{Table reference not working}
