...
\conclusionbox{We find that the Stanford Classifier, is more effectively to identify \SATD comments than the current state-of-art approach. We achieved an average F1 measure of 0.62 identifying design debt and an average of 0.51 while classifying requirement debt.}
