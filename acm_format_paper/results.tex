...
Lastly, we extract these features from each project analyzed in our work and analyze the results. 


\vspace{1mm}
\noindent \textbf{Results:} Table \ref{tbl:top_ten_features} shows the top 10 features identifying \SATD in the ten studied projects.
...
\begin{table}[!hbt]
    \begin{center}
        ...
        \begin{tabular}{l | l }
        \toprule
        \thead{Design\\TD} & \thead{Requirement\\TD} \\
        \midrule
         hack                  &  TODO:           \\
         workaround            &  FIXME:          \\
         yuck!                 &  needed          \\
