...
To be throughout in this analysis, we apply this approach for each one of our ten studied projects for design and requirement \SATD comments. We also experimented with the order that the comments were added to the training dataset. We ranked the projects that contained more \SATD of the specific type being classified so that they can be added first to training dataset. Then, we repeat the experiment adding first the projects which has less \SATD of the specific type being classified.       
