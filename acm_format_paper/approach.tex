...
\begin{table*}[!tbh]
    ...
    \label{tab:project_details}
            ...
            \toprule
            % \textbf{Project}   & \textbf{Release}  & \textbf{\# of classes}   & \textbf{SLOC}  & \textbf{\# of comments} & \textbf{\# of TD comments} & \textbf{\# of contributors} & \textbf{\% of Design Debt} & \textbf{\% of Requirement Debt}\\ 
