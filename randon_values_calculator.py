    ...
    for key, value in execution_types.iteritems():
        ...
        for test_project_result in test_projects:
            ...
            if not "WITHOUT_CLASSIFICATION" in execution_td_type :
                ...
                cursor.execute("update classifier_results set withoutclassificatiorandomprecision = '"+str(round(randon_precision, 3))+"', withoutclassificatiorandomrecall = '"+str(round(randon_recall, 3))+"' , withoutclassificatiorandomf1 = '"+str(round(randon_f1, 3))+"', baselineprecision = '"+str(round(precision, 3))+"', baselinerecall = '"+str(round(recall, 3))+"' , baselinef1 = '"+str(round(f1measure, 3))+"'  where projectname = '"+test_project+"'")
