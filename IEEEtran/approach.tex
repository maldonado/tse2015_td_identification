...
\begin{table*}[thb!]
    \begin{center}
    \caption{Details of Studied Projects \emad{make the headings and project names}}
...
\nikos{I think it would be helpful to give an example of a comment, and the features (words) used to classify it as technical debt}
